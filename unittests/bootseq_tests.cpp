...
const uint64_t max_supply_count = 190'473'249'0000;   // max PAYB supply of 190,473,249 (fluctuating value until mainnet activation)
const uint32_t activation_threshold = 15;             // 15% treshold required for vote
const uint64_t min_activated_stake = 28'570'987'0000; // calculated from max PAYB supply of 190,473,249 (fluctuating value until mainnet activation)
const double continuous_rate = 0.025;                // 2.5% annual inflation rate
const double producer_rate = 0.01;                   // 1% PAYB rate to BP/Standby
const double worker_rate = 0.015;                    // 1.5% PAYB rate to worker fund
